  ...
  return (
    ...
    >
      <motion.div
        ...
        style={
          {
            width: size * 0.5, // Keep the beam length long relative to size
            height: Math.max(borderWidth * 4, 12), // Keep height tight to the border to avoid bleeding to opposite sides
